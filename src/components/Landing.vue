<template>
  <div class="landing container">
	...
	<div @click.stop> 
	  ...
	  <b-dropdown  size="sm" id="ddown1" text="" class="mh-100 float-right">
...
import PerfectScrollbar from 'perfect-scrollbar';
  ...
  var componentData = {
      ...
      booksFB: [{ title: 'The box', author: 'John', type: 'fiction'},
		{ title: 'Hello'  , author: 'Jane', type: 'fiction'},
		{ title: 'The box', author: 'Paul', type: 'fiction'},
		{ title: 'The box', author: 'Kate', type: 'fiction'},
		{ title: 'The box', author: 'Amanda', type: 'fiction'},
		{ title: 'The box', author: 'Steve', type: 'fiction'},
		{ title: 'The box', author: 'Keith', type: 'fiction'},
		{ title: 'The box', author: 'Don', type: 'fiction'},
		{ title: 'The box', author: 'Susan', type: 'fiction'}],
      filter: null,
      fields: [
	  {
	      key: 'title',
